		...
		<div class="section_container">
			<div class="pay-skip">
				...
				<div class="payskip-inner">
					...
					<div>
						<span>支付方式：</span><img class="zffs" src="${shop}/images/yibao.png"/>
					</div>
					<div>
					...
					<form name="yeepay" action='https://www.yeepay.com/app-merchant-proxy/node' method='POST' target="_blank">
						...
						<input type='hidden' name='hmac'     value='${requestScope.hmac}'><br>
						<div class="pay-inner">
                    		<input type="submit" style="width: 200px; height: 40px;" value="登陆网上银行，立即支付" />
                    	</div>
					</form>
				</div>
			</div>
