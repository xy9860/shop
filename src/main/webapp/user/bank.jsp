            ...
            <div class="pay-step">
                ...
                <div class="person-check check">
                    ...
                    <div class="person-checkinner">
                        <div><span>订单号</span>：<span>${sessionScope.oldForder.fid}</span></div>
                        <div><span>收货人</span>：<span>${sessionScope.oldForder.fname}</span></div>
                        <div><span>送货地址</span>：<span>${sessionScope.oldForder.faddress}</span></div>
                        <div><span>邮政编码</span>：<span>${sessionScope.oldForder.fpost}</span></div>
                        <div><span>支付金额</span>：<span>${sessionScope.oldForder.ftotal}</span></div>
                    </div>
                </div>
                <div class="pay">
                    <div class="pay-inner">
